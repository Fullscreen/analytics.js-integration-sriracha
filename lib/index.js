...
var Sriracha = exports = module.exports = integration('Sriracha.io')
  .option('apiKey', '')
...
Sriracha.prototype.initialize = function() {
  var self = this;

  if (this.options.retryQueue) {
    this._lsqueue = new Queue('sriracha', function(item, done) {
...
Sriracha.prototype.loaded = function() {
  return true;
};
...
Sriracha.prototype.onpage = function(page) {
  this.send('', page.json());
};
...
Sriracha.prototype.onidentify = function(identify) {
  this.send('', identify.json());
};
...
Sriracha.prototype.ongroup = function(group) {
  this.send('', group.json());
};
...
Sriracha.prototype.ontrack = function(track) {
  var json = track.json();
...
Sriracha.prototype.onalias = function(alias) {
  var json = alias.json();
...
Sriracha.prototype.normalize = function(msg) {
...
Sriracha.prototype.ampId = function(ctx) {
...
Sriracha.prototype.send = function(path, msg, fn) {
...
Sriracha.prototype.cookie = function(name, val) {
  var store = Sriracha.storage();
...
Sriracha.prototype.referrerId = function(query, ctx) {
 ...
 */
Sriracha.prototype.retrieveCrossDomainId = function(callback) {
